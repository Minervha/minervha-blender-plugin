...
per-mesh offender bars + an experimental banner, and a collapsed **Texture inventory** sub-panel (images by
dimension, largest first, marking those the 8k rule will downscale). The old static "Scene export limits" hint
